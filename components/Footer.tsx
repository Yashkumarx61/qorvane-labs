...
export function Footer() {
  ...
  return (
    <footer className="border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 text-slate-700 dark:text-slate-300 pt-16 pb-12 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 pb-12 border-b border-slate-200 dark:border-slate-800">
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="flex items-center space-x-3 pt-2">
              <div className="flex items-center space-x-1.5 text-[11px] text-slate-500 dark:text-slate-400 px-2.5 py-1 rounded-md border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-900">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <Link href="/services/web-development" className="hover:text-brand-600 dark:hover:text-brand-400 transition-colors">
                  Custom Web Development
                </Link>
              </li>
              <li>
                <Link href="/services/mobile-apps" className="hover:text-brand-600 dark:hover:text-brand-400 transition-colors">
                  Mobile App Engineering
                </Link>
              </li>
              <li>
                <Link href="/services/ai-data" className="hover:text-brand-600 dark:hover:text-brand-400 transition-colors">
                  AI & Intelligent Data
                </Link>
              </li>
              <li>
                <Link href="/services/business-analytics" className="hover:text-brand-600 dark:hover:text-brand-400 transition-colors">
                  Business Analytics & BI
                </Link>
              </li>
              <li>
                <Link href="/services/managed-it" className="hover:text-brand-600 dark:hover:text-brand-400 transition-colors">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li>
                <Link href="/portfolio" className="hover:text-brand-600 dark:hover:text-brand-400 transition-colors flex items-center justify-between">
          ...
          <div className="space-y-3">
            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="space-y-2">
                <input
                  ...
                  className="w-full px-3.5 py-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 text-xs text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-brand-500"
                />
                <button
                  type="submit"
                  className="w-full py-2 px-3 rounded-xl bg-slate-900 dark:bg-slate-100 hover:bg-slate-800 dark:hover:bg-white text-white dark:text-slate-900 font-semibold text-xs transition-colors flex items-center justify-center space-x-1.5"
                >
            ...
            <div className="pt-2 flex items-center space-x-3">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="p-2 rounded-lg border border-slate-200 dark:border-slate-800 hover:text-brand-500 transition-colors"
                aria-label="LinkedIn"
              >
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 dark:text-slate-400 space-y-3 sm:space-y-0">
          <div>
