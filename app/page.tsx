...
export default function HomePage() {
  ...
  return (
    <div className="relative overflow-hidden bg-[#F8FAFC]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
          <div className="text-center max-w-4xl mx-auto space-y-6">
            ...
            <motion.div
              ...
              className="inline-flex items-center space-x-2.5 px-4 py-1.5 rounded-full bg-slate-900/5 border border-slate-200 text-slate-800 text-xs font-semibold shadow-sm backdrop-blur-md"
            >
            ...
            >
              ...
              <Link
                href="/solutions"
                className="w-full sm:w-auto px-8 py-4 rounded-2xl border border-slate-300 bg-white/80 hover:bg-slate-100 text-slate-900 font-bold text-sm backdrop-blur-md flex items-center justify-center space-x-2 transition-all shadow-sm"
              >
            ...
            <motion.div
              ...
              className="pt-10 grid grid-cols-2 sm:grid-cols-4 gap-4 border-t border-slate-200/80 max-w-3xl mx-auto text-left"
            >
              <div className="p-3">
              ...
              <div className="p-3">
                <div className="text-2xl font-extrabold text-slate-900">2.8x</div>
              ...
              <div className="p-3">
                <div className="text-2xl font-extrabold text-slate-900">Dehradun</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {servicesData.map((service) => (
              <div
                key={service.id}
                className="glass-card p-8 rounded-3xl border border-slate-200 hover:border-brand-500/40 transition-all duration-300 group flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <div className="w-12 h-12 rounded-2xl bg-brand-500/10 text-brand-600 flex items-center justify-center group-hover:scale-110 transition-transform">
                    ...
                    {service.badge && (
                      <span className="px-3 py-1 rounded-full bg-slate-100 text-[11px] font-semibold text-slate-600">
                        {service.badge}
                      </span>
                    )}
                  </div>
                ...
                <div className="pt-8">
                  <Link
                    ...
                    className="w-full py-2.5 rounded-xl border border-slate-200 text-xs font-semibold text-slate-800 hover:bg-brand-600 hover:text-white hover:border-brand-600 flex items-center justify-center space-x-2 transition-all"
                  >
      ...
      <section className="py-20 bg-slate-50/50 border-y border-slate-200 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-4">
            <div>
              <span className="text-xs font-bold uppercase tracking-wider text-brand-600">
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="glass-card p-8 sm:p-10 rounded-3xl border border-slate-200 relative overflow-hidden flex flex-col justify-between">
            ...
            {/* Dedicated Pods */}
            <div className="glass-card p-8 sm:p-10 rounded-3xl border border-brand-500/40 bg-brand-500/5 relative overflow-hidden flex flex-col justify-between">
              <div className="space-y-4">
