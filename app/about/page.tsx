    ...
    <div className="pt-32 pb-24 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="glass-card p-8 rounded-3xl border border-slate-200 space-y-3">
          ...
          <div className="glass-card p-8 rounded-3xl border border-slate-200 space-y-3">
            <div className="w-10 h-10 rounded-xl bg-tealAccent-500/10 text-tealAccent-600 flex items-center justify-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              <div className="flex items-start space-x-2.5">
                ...
                <span>State-of-the-art optical fiber cloud connectivity</span>
              </div>
              <div className="flex items-start space-x-2.5">
                <CheckCircle2 className="w-4 h-4 text-tealAccent-400 shrink-0 mt-0.5" />
