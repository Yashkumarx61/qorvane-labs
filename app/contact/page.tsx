      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-7">
            <div className="glass-card p-8 sm:p-10 rounded-3xl border border-slate-200 shadow-2xl">
              {submitted ? (
                <div className="py-16 text-center space-y-4">
                  ...
                  <p className="text-sm text-slate-600 max-w-md mx-auto">
                    Thank you, <span className="font-semibold text-brand-600">{formData.name}</span>. A senior solution architect from our Dehradun hub will review your specifications and contact you at <span className="font-semibold text-brand-600">{formData.email}</span>.
                  </p>
                  <div className="pt-4">
                    <button
                      onClick={() => {
                      ...
                      className="px-6 py-2.5 rounded-xl border border-slate-300 text-xs font-bold text-slate-800 hover:bg-slate-100"
                    >
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            {/* Dehradun IT Park Office Location */}
