    ...
    <div className="pt-32 pb-24 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Card 1: Fixed Scope */}
          <div className="glass-card p-8 sm:p-10 rounded-3xl border border-slate-200 dark:border-slate-800 space-y-6 shadow-xl">
            ...
            <div className="space-y-3 pt-2 text-xs">
              ...
              <div className="p-3 rounded-xl bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700">
                <span className="font-semibold text-slate-900 dark:text-white">Billing Model:</span>
                <span className="text-slate-600 dark:text-slate-300 ml-1">
                  Milestone-based payments (25% Upfront, 50% Beta, 25% Production Launch).
                </span>
              </div>
              <div className="p-3 rounded-xl bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700">
                <span className="font-semibold text-slate-900 dark:text-white">Project Ownership:</span>
                <span className="text-slate-600 dark:text-slate-300 ml-1">
          ...
          <div className="glass-card p-8 sm:p-10 rounded-3xl border border-brand-500/40 bg-brand-500/5 dark:bg-brand-500/10 space-y-6 shadow-xl">
            ...
            <div className="space-y-3 pt-2 text-xs">
              ...
              <div className="p-3 rounded-xl bg-slate-100 dark:bg-slate-800/60 border border-slate-200 dark:border-slate-700">
                <span className="font-semibold text-slate-900 dark:text-white">Direct Access:</span>
                <span className="text-slate-600 dark:text-slate-300 ml-1">
